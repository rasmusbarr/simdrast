...
/*****************************************************************************\
PROTOTYPES
These should probably be removed from this file before releasing to ISVs
\*****************************************************************************/
struct SDevice;
BOOL HandleCapsExtension( SDevice* pDevice, CONST D3D10_DDIARG_SUBRESOURCE_UP* pInitialDataUP );
BOOL HandleResourceExtension( SDevice* pDevice, CONST D3D10_DDIARG_SUBRESOURCE_UP* pInitialDataUP );
BOOL HandleStateExtension( SDevice* pDevice, CONST D3D10_DDIARG_SUBRESOURCE_UP* pInitialDataUP );

RESOURCE_EXTENSION* GetActiveResourceExtension( SDevice* pDevice );
STATE_EXTENSION* GetActiveStateExtension( SDevice* pDevice );

void ClearActiveResourceExtension( SDevice* pDevice );
void ClearActiveStateExtension( SDevice* pDevice );
#endif
